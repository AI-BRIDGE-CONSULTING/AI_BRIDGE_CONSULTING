        ...
        <div className={styles.reasons}>
          ...
          <div className={styles.reasonBox}>
            ...
            <p>
              ...
              wprowadzać nowe produkty, optymalizować ofertę i reagować na
              zmiany w branży. To daje realną przewagę konkurencyjną.
            </p>
          </div>
          <div className={styles.reasonBox}>
            <div className={styles.boxHeader}>
            ...
            <p>
              ...
              Twoja firma przestaje być ograniczona godzinami pracy zespołu. To
              szczególnie ważne przy sprzedaży online i klientach z różnych
              stref czasowych.
            </p>
          </div>
          <div className={styles.reasonBox}>
            ...
            <p>
              ...
              poprzez personalizację ofert i lepsze targetowanie reklam. Mniej
              kosztów + większe przychody = lepsza rentowność.
            </p>
          </div>
          <div className={styles.reasonBox}>
            <div className={styles.boxHeader}>
            ...
            <p>
              ...
              mogą z nich korzystać bez programowania. Dzięki temu całe
              przedsiębiorstwo może szybko wdrożyć nowe rozwiązania.
            </p>
          </div>
          <div className={styles.reasonBox}>
            <div className={styles.boxHeader}>
            ...
            <p>
              ...
              rozbudowanej infrastruktury IT. To pozwala szybko zobaczyć
              pierwsze efekty i skalować rozwiązania wraz z rozwojem firmy.
            </p>
          </div>
        </div>
      </div>
